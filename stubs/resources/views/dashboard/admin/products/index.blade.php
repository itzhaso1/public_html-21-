            ...
            <div class="pt-5 border-0 card-header">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover">
                        ...
                        <button type="button" class="btn btn-sm btn-light btn-active-success" data-bs-toggle="modal"
                        ...
                        <form action="{{ route('admin.test-erp-connection') }}" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-default">الارسال للـ ERP</button>
                        </form>
                    </div>
                    @include('dashboard.admin.products.partials.modalImport')
