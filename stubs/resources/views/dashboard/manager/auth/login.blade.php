...
@section('content')
    ...
    <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
        ...
        <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
            ...
            <form class="form w-100" novalidate="novalidate" method="POST" id="kt_sign_in_form" action="{{route('manager.post.login')}}">
                @csrf
                <!--begin::Heading-->
                <div class="text-center mb-10">
                    <!--begin::Title-->
                    <h1 class="text-dark mb-3">تسجيل دخول مدير فرع</h1>
                    <!--end::Title-->
                </div>
                <!--begin::Heading-->
                <!--begin::Input group-->
                ...
                <div class="fv-row mb-10">
                    ...
                    <div class="d-flex flex-stack mb-2">
                        ...
                        <!--end::Label-->
                        <!--begin::Link-->
                        <a href="{{-- route('manager.forgot.password') --}}" class="link-primary fs-6 fw-bolder">{{ trans('dashboard/auth.forgot_password') }}</a>
                        <!--end::Link-->
                    </div>
                    <!--end::Wrapper-->
                    <!--begin::Input-->
