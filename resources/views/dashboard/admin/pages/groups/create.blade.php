...
<div id="kt_content_container" class="container-xxl">
    <div class="mb-5 card card-xxl-stretch mb-xl-8">
        ...
        <div class="py-3 card-body">
            <form action="{{-- route('admin.pages.group_store') --}}" method="POST">
                @csrf
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade @if($loop->index == 0) show active @endif" id="{{$key}}"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="{{$key}}[name]"
                                            class="form-label">{{trans('dashboard/group.name') .
                                            ' / ' . $lang['native']}}</label>
                                        <input type="text" id="{{$key}}[name]" name="{{$key}}[name]"
                                            placeholder="{{trans('dashboard/group.group_name_placeholder') . ' / ' . $lang['native']}}"
