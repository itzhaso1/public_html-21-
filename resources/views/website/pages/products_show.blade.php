                                ...
                                <div class="product-details-popup">
                                    <div class="details-product-area">
                                        <div class="product-thumb-area">
                                            ...
                                            <div class="thumb-wrapper one filterd-items figure">
                                                <div class="product-thumb zoom" onmousemove="zoom(event)"
                                                    style="background-image: url({{$product->getMediaUrl('product', $product, null, 'media', 'product') }})"><img
                                                        src="{{$product->getMediaUrl('product', $product, null, 'media', 'product') }}" alt="product-thumb">
                                                </div>
                                            </div>
                                        ...
                                        <div class="contents">
                                            ...
                                            <span class="product-price mb--15 d-block" style="color: #DC2626; font-weight: 600;"> {{$product?->price}}<span class="old-price ml--15">{{$product?->price_before_discount}}</span></span>
                                            ...
                                            <div class="product-uniques">
                                                <span class="sku product-unipue mb--10"><span style="font-weight: 400; margin-right: 10px;">SKU: </span> {{$product?->sku}}</span>
                                ...
                                <div class="swiper-slide">
                                    <div class="single-shopping-card-one">
                                        <div class="image-and-action-area-wrapper">
                                            <a href="{{ route('shop.product.show', $related->id) }}" class="thumbnail-preview">
                                        ...
                                        <div class="body-content">
                                            ...
                                            <div class="price-area">
                                                ...
                                                <div class="previous">${{ number_format($related->price_before_discount, 2) }}</div>
                                                @endif
                                            </div>
